...
@property(nonatomic,strong)void (^xiuGaiGongShiBlock)(OrderDetailPartsModel *peiJianListModel);
@property(nonatomic,strong)void (^xiuGaiGongShiFeiBlock)(OrderDetailPartsModel *peiJianListModel);


@property(nonatomic,strong)OrderDetailPartsModel *peiJianListModel;

...
- (void)viewDidLoad {
    ...
    shengChengBt.backgroundColor = kNavBarColor;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        cell.zuoLabel.text = @"车牌号";
        cell.youLabel.text = self.zhuModel.car_number;
    ...
    }else
    {
        ...
        }else if(indexPath.row == 1)
        {
            ...
            cell.mainTextField.text = [NSString stringWithFormat:@"%.2f",qianstr];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (section == 2) {
        ...
        rightLabel.textColor = kNavBarColor;

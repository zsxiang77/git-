...
@interface SettingAITSerialNumberVC ()<UITextFieldDelegate>
{
...
- (void)viewDidLoad {
    ...
    [xiaImageView  sd_setImageWithURL:[NSURL URLWithString:@"http://inflexion.icarzoo.com/res/backstage/images/ait_example.png"] placeholderImage:DJImageNamed(@"xiangMuBack")];

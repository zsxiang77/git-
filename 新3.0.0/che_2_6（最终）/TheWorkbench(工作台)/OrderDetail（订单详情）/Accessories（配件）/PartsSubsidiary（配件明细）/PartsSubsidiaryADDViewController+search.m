//
//  PartsSubsidiaryADDViewController+search.m
//  cheDianZhang
//
...
@implementation PartsSubsidiaryADDViewController (search)
...
-(void)searchPeijian:(NSString *)strText
{
    ...
    kWeakSelf(weakSelf)
    [NetWorkManager requestWithParameters:mDict withUrl:@"order/repair_order/search_part" viewController:self withRedictLogin:YES isShowLoading:YES success:^(id responseObject) {

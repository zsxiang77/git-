...
- (instancetype)initWithFrame:(CGRect)frame customsegmentStyle:(ZJSegmentStyle *)segmentStyle childVcs:(NSArray *)childVcs parentViewController:(NSArray *)titlesArray;
/** 给外界设置选中的下标的方法 */

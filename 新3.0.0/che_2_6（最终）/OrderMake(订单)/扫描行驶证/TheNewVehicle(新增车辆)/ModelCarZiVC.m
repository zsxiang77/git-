...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    self.xinZengModel.type = KISDictionaryHaveKey(self.maiArray[indexPath.row], @"name");
    self.xinZengModel.type_id = KISDictionaryHaveKey(self.maiArray[indexPath.row], @"series_id");

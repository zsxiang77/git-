...
@interface IDCardCameraViewController : BaseViewController<AVCaptureVideoDataOutputSampleBufferDelegate>
...
@property (strong, nonatomic) void (^saoMiaoXSZHuiBlcok)(XinShiZheng_carsModel *model);

...
-(void)bianJiButtonChick:(UIButton *)sender
{
    ...
    [NetWorkManager requestWithParameters:mDict withUrl:@"user/ucenter/change_real_name" viewController:self withRedictLogin:YES isShowLoading:YES success:^(id responseObject) {

...
@interface BossUserMeViewController ()<UITableViewDelegate,UITableViewDataSource,UINavigationControllerDelegate,UIImagePickerControllerDelegate,UIActionSheetDelegate>
...
@implementation BossUserMeViewController
...
-(void)postHuoQuUser_info
{
    ...
    [BOSSNetWorkManager requestWithParameters:mDict withUrl:@"user/ucenter/user_info" viewController:self withRedictLogin:YES isShowLoading:YES success:^(id responseObject) {
...
- (void)getQiNiuTokenFromServer:(UIImage *)image
{
    ...
    kWeakSelf(weakSelf)
    [BOSSNetWorkManager touXiangrequestDuoZhangWithParametersUIImageJPEGRepresentationWithUrl:@"order/order_queue/upload_file" viewController:self isShowLoading:YES withimage:array success:^(id responseObject) {
...
-(void)changTouXiang:(NSString *)dizhi
{
    ...
    kWeakSelf(weakSelf)
    [BOSSNetWorkManager requestWithParameters:mDict withUrl:@"data_center/privateinfo/staff_avatar2" viewController:self withRedictLogin:YES isShowLoading:YES success:^(id responseObject) {

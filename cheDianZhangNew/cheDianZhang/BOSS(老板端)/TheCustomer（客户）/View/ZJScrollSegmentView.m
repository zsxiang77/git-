...
- (instancetype)initWithFrame2:(CGRect )frame segmentStyle:(ZJSegmentStyle *)segmentStyle titles:(NSArray *)titles titleDidClick:(TitleBtnOnClickBlock)titleDidClick withIndex:(NSInteger)index {
    if (self = [super initWithFrame:frame]) {
        self.segmentStyle = segmentStyle;
        self.titles = titles;
        self.titleBtnOnClick = titleDidClick;
...
- (void)setUpLabelsPosition {
    ...
    ZJCustomLabel *firstLabel = (ZJCustomLabel *)self.titleLabels[self.currentIndex];

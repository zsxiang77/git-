...
- (void) keyboardWillShow:(NSNotification*)noti
{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        weakSelf.faBuView.frame = CGRectMake(0, kWindowH-53-CGRectGetHeight(keyboardFrameBeginRect), kWindowW, 53);
    }];
}
...
{
    if (!_mainTableView) {
        _mainTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, kBOSSNavBarHeight, kWindowW, kWindowH-kBOSSNavBarHeight-53) style:UITableViewStylePlain];

...
-(void)shuaXinHeaderView
{
    ...
    [self.xiMeiDetailHeaderView.topMianImageView  sd_setImageWithURL:[NSURL URLWithString:model.brand_img] placeholderImage:DJImageNamed(@"")];
    ...
    self.xiMeiDetailHeaderView.erWeiMaImageView.image  = [SuccessfulOrderViewController qrCodeImageWithContent:model.order_url codeImageSize:180 red:0 green:0.658 blue:1];
...
{
    Order_info *model = (Order_info *)self.zhuModel.order_info;
    [self.xiMeiDetailHeaderView2.topMianImageView  sd_setImageWithURL:[NSURL URLWithString:model.brand_img] placeholderImage:DJImageNamed(@"")];
    ...
    self.xiMeiDetailHeaderView2.erWeiMaImageView.image  = [SuccessfulOrderViewController qrCodeImageWithContent:model.order_url codeImageSize:180 red:0 green:0.658 blue:1];

...
- (void)viewDidLoad {
    ...
    wechatImageView.image = [SuccessfulOrderViewController qrCodeImageWithContent:KISDictionaryHaveKey(self.chuZhiDict, @"query_url") codeImageSize:130 red:0 green:0.658 blue:1];//重绘二维码,使其显示清晰

...
- (void)viewDidLoad
{
    ...
    m_webView = [[WKWebView alloc] initWithFrame:CGRectMake(0, kNavBarHeight, CGRectGetWidth(self.view.frame), CGRectGetHeight(self.view.frame)-kNavBarHeight)];
    if(self.isNoShowNavBar){
        m_webView.frame = CGRectMake(0, 20, CGRectGetWidth(self.view.frame), CGRectGetHeight(self.view.frame));
    }
    else{
        [self buildNavBar];

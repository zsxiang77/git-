...
-(void)shuaXinHeaderView
{
    ...
    [self.orderDetailHeaderView.topMianImageView  sd_setImageWithURL:[NSURL URLWithString:model.brand_img] placeholderImage:DJImageNamed(@"ic_launcher")];
    ...
    self.orderDetailHeaderView.erWeiMaImageView.image  = [SuccessfulOrderViewController qrCodeImageWithContent:model.order_url codeImageSize:180 red:0 green:0 blue:1];

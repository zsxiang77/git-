...
//    self.chuanzhiModel.ordercode = @"0100100172544791";
    ...
    _xiangMuMingXiibool  = NO;
    _peiJianMingXibool  = NO;
    
    UIButton* backButton = [[UIButton alloc] initWithFrame:CGRectMake(kWindowW-54, 20, 44, 44)];
    ...
    UIImageView *closeBtImagVie = [[UIImageView alloc]initWithImage:DJImageNamed(@"close")];
    [m_baseTopView addSubview:closeBtImagVie];
    [closeBtImagVie mas_makeConstraints:^(MASConstraintMaker *make) {
        make.center.mas_equalTo(backButton);
        make.width.height.mas_equalTo(20);
    }];
    [m_baseTopView bringSubviewToFront:backButton];
    
    self.mainTableView.hidden = NO;
    
    UIButton *wanChengBt = [[UIButton alloc]initWithFrame:CGRectMake(10, kWindowH-60, kWindowW-20, 40)];
    wanChengBt.backgroundColor = kNavBarColor;
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (section == 0) {
        ...
        [guanLibt setTitleColor:kNavBarColor forState:(UIControlStateNormal)];
        ...
        [guanLibt2 setTitleColor:kNavBarColor forState:(UIControlStateNormal)];

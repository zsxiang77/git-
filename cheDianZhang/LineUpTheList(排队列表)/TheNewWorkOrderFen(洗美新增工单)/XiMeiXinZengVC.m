...
- (void)viewDidLoad {
    ...
    xiYiBuBt.backgroundColor = kNavBarColor;
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    backView.backgroundColor = kRGBColor(220, 220, 220);
    if (section == 1) {
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    UIButton *xinZengBt = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, kWindowW, 40)];
    ...
    UILabel *yingView = [[UILabel alloc]init];
    yingView.frame=CGRectMake(0, 40, kWindowW, 1);
    yingView.backgroundColor=[UIColor grayColor];
    yingView.layer.shadowOffset =  CGSizeMake(1, 1);
    yingView.layer.shadowOpacity = 0.8;
    yingView.layer.shadowColor =  [UIColor grayColor].CGColor;
    [footView addSubview:yingView];

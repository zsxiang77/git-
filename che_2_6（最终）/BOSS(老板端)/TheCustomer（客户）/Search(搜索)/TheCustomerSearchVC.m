...
@interface TheCustomerSearchVC ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
...
@implementation TheCustomerSearchVC

- (void)viewDidLoad {
    [super viewDidLoad];
    [self setTopViewWithTitle:@"客户" withBackButton:YES];
    self.shangView = [[UIView alloc]initWithFrame:CGRectMake(0, kBOSSNavBarHeight, kWindowW, 44+55)];
...
{
    if (!_mainTableView) {
        _mainTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, kBOSSNavBarHeight+44+55, kWindowW, kWindowH-(kBOSSNavBarHeight+44+55)) style:UITableViewStylePlain];

...
@interface NJTXViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation NJTXViewController
...
-(CPHFWeiHeaderView *)headerView
{
    if (!_headerView) {
        ...
        kWeakSelf(weakSelf)
        _headerView.nianJianTiXingBlcok = ^{
            weakSelf.nianJIanzhanHe =!weakSelf.nianJIanzhanHe;
            [weakSelf.headerView refreshDataNianJian:weakSelf.mainDataDict withZhanHe:weakSelf.nianJIanzhanHe];

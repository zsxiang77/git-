...
@interface SRKLViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@property(nonatomic,strong)UILabel *xiaCuilabel;


@end

@implementation SRKLViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    [self setTopViewWithTitle:@"年检体醒" withBackButton:YES];

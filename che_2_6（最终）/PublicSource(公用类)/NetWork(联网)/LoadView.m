...
//        UIImage *gifImage = DJImageNamed(@"gif20.gif");
//
//
//        mainWebView = [[UIWebView alloc]initWithFrame:CGRectMake(kWindowW/2-50, kWindowH/2-50, gifImage.size.width, gifImage.size.height)];

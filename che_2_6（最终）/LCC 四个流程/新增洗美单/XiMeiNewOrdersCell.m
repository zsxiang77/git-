...

{
    ...
    if (self) {
        ...
        [_lotteryImage.layer setCornerRadius:imageW/2];
        ...
        self.xuanZhongImage = [[UIImageView alloc]initWithImage:DJImageNamed(@"ic_checked")];
        [self.contentView addSubview:self.xuanZhongImage];
        [self.xuanZhongImage mas_makeConstraints:^(MASConstraintMaker *make) {
            make.size.mas_equalTo(20);
            make.bottom.right.mas_equalTo(self.lotteryImage);
        }];
    }
